    ...
    eventDecsription("Description"), deleteButton(new QPushButton())
{
    ...
    informationLayout->addWidget(deleteButton, 2, Qt::AlignLeft | Qt::AlignTop);
    ...
    informationLayout->addLayout(dateTimeLayout, 3);
...
//EventItem &EventItem::operator=(const EventItem &)
//{

//}

//EventItem::EventItem(const EventItem &other) : painter(new QWidget)
//{
